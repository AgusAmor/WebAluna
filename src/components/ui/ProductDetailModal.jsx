  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden font-family-sora">
      ...
      <div className="flex min-h-screen items-center justify-center p-2 sm:p-4">
        <div
          className="relative bg-white rounded-lg sm:rounded-xl shadow-xl max-w-3xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden animate-fadeInScale flex flex-col md:flex-row gap-4 md:gap-10 p-3 sm:p-6"
