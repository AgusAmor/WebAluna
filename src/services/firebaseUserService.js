...
/**
 * Creates a new user document in Firestore via Cloud Function.
 * Requires a valid Firebase Auth token for authentication.
 * @param {Object} user - User data (uid, email, displayName, etc.)
...
/**
 * Updates an existing user in Firestore via Cloud Function.
 * Requires the user ID, updated fields, and a valid Firebase Auth token.
